...
#. use the search functionality `here <https://github.com/sunxb05/aichem/issues>`__ to see if someone already filed the same issue;
...
#. `push <http://rogerdudler.github.io/git-guide/>`_ your feature branch to (your fork of) the aichem repository on GitHub;
